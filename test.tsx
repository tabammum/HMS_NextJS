...
export default function Test() {
    ...
    useEffect(() => {
        ...
        axiosInstance.get('accountants/test')
            .then(response => {
    ...
    const handleSearch = (event: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setSearchTerm(term);
        const filtered = test.filter(Test =>
            ...
            <div className="grid grid-cols-12 ">
                ...
                <div className="col-span-9">
                    <div className="container flex flex-col min-h-screen mx-auto ">
                        ...
                        <h1 className="px-4 text-3xl font-semibold">Test List</h1>
                                ...
                                <table className="w-full my-2 text-sm text-left text-gray-500 dark:text-gray-400">
                                    <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 rounded-t-md">
                                        <tr>
                                            ...
                                            <th  scope="col" className="px-6 py-3">RefdBy</th>
                                    ...
                                    {test.map(Test => ( 
                                            <tr key={Test.id} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                                ...
                                                <td className="px-6 py-4">{Test.age}</td>
                                                <td className="px-6 py-4">{Test.refdBy} </td>
                                                <td className="px-6 py-4">{Test.date}</td>
                                                <td className="px-6 py-4">{Test.time}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
